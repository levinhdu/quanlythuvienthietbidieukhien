    ...
    return <CustomScrollbars className="gx-customizer">
      <div className="gx-customizer-item">
        ...
        <Radio.Group value={themeType} onChange={onThemeTypeChange}>
          <Radio.Button value={THEME_TYPE_LITE}>Sáng</Radio.Button>
          <Radio.Button value={THEME_TYPE_SEMI_DARK}>Sáng Tối</Radio.Button>
          <Radio.Button value={THEME_TYPE_DARK}>Tối</Radio.Button>
        </Radio.Group>
      </div>
      <div className="gx-customizer-item">
      ...
      <h6 className="gx-mb-3 gx-text-uppercase">Kiểu Menu</h6>
